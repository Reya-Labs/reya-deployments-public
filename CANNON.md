...
The latest completed devnet release is **1.1.10**, executed and published on
...
CI and both devnet package scripts now restore **`reya-devnet-omnibus:1.1.10@main`**,
complete deploy CID **`QmSZLPrV1HgTYUC2QpRwe7GxGw5CWo5jSC4Z6RLB6pannv`**.
...
paragraph at 1.1.5; #540, #541 and #534 realigned all four in their completed-record commits.)
...
unchanged 1.1.10 rehearsal from its completed record must make zero protocol
...
```bash
REF=reya-devnet-omnibus:1.1.10@main
...
Mainnet upgrades `reya-omnibus:1.0.166@main` to `1.1.0`; Cronos upgrades
`reya-omnibus:1.0.148@main` to `1.1.0`. Devnet advances completed `1.1.10` to candidate `1.1.11`.
